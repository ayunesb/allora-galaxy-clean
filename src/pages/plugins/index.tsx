...
import { Sparkles, ArrowRight, BarChart3, Settings, Filter, Plus, ArrowUpRight } from 'lucide-react';
      ...
      <div className="container mx-auto py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Manage and monitor your AI plugin ecosystem</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>Track performance metrics and XP</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground text-center max-w-md">
                Create your first plugin to start building your AI intelligence ecosystem.
              </p>
