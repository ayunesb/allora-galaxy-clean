            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Your API key is stored only in your browser and is never sent
                  to our servers.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              {!apiKey && (
                <div className="mt-4 bg-yellow-50 text-yellow-800 p-4 rounded-md">
                  <p className="text-sm">
                    Please set your API key in the "API Key" tab before using
                    the playground.
                  </p>
                </div>
              )}
