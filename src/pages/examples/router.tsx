...
const ErrorStateExamplesPage = lazyPage(() => import('./ErrorStateExamplesPage'));
  ...
  return (
    <ErrorBoundary>
      <Routes>
        ...
        <Route path="*" element={<Navigate to="/examples/error-states" replace />} />
      </Routes>
    </ErrorBoundary>
  );
};
