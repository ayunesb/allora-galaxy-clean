	...
	return (
		<div className="container mx-auto py-8 max-w-3xl">
			...
			<Alert className="mb-6">
				<AlertDescription>
					Requesting account deletion will initiate the process of removing your
					account and all associated data. This action cannot be undone once
					completed.
				</AlertDescription>
			</Alert>
			...
			<Card>
				...
				<CardContent>
					<p className="mb-6">
						To proceed with account deletion, please click the button below. A
