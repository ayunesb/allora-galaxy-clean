        ...
        <Card>
          <CardContent className="pt-6">
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p>
                Allora OS collects several types of information for various
              ...
              <ul>
                ...
                <li>
                  Cookies and Tracking Data: For analytics and service
                  improvement
                </li>
              </ul>

              <h2>2. Use of Data</h2>
              <p>Allora OS uses the collected data for various purposes:</p>
              <ul>
              ...
              <ul>
                <li>
                  Functional Cookies: To recognize you and remember your
                ...
                <li>
                  Marketing Cookies: To deliver advertisements that may be
              ...
              <p>
                Allora OS aims to ensure you are fully aware of all your data
                protection rights:
              </p>
              <ul>
              ...
              <p>
                Allora OS utilizes artificial intelligence and automated
                processing to enhance our services. The AI systems process your
                data to provide insights, automate workflows, and improve user
                experience. You have the right to:
              </p>
              <ul>
                <li>
                  Request human intervention in decisions made solely by
                  automated means
                </li>
                <li>
              ...
              <p>
                ...
                contact us at privacy@alloraos.com.
              </p>
            </div>
          </CardContent>
        </Card>
