...
describe('chartDataUtils', () => {
  ...
  describe('filterErrorTrendDataByDateRange', () => {
    const trendData = [
      { date: '2023-01-01', count: 2, total: 10, critical: 1, high: 1, medium: 0, low: 0 },
      { date: '2023-01-02', count: 3, total: 12, critical: 0, high: 2, medium: 1, low: 0 },
      { date: '2023-01-03', count: 1, total: 8, critical: 0, high: 0, medium: 0, low: 1 },
      { date: '2023-01-04', count: 4, total: 15, critical: 2, high: 1, medium: 1, low: 0 }
    ];
    ...
    it('should filter by date range (start and end)', () => {
      ...
      const result = filterErrorTrendDataByDateRange(trendData, startDate, endDate);
