				...
				<Tabs defaultValue="display">
					...
					<TabsContent value="display" className="space-y-4">
						...
						<EdgeFunctionHandler
							...
							error={error}
							onRetry={() =>
								error && triggerError((error as any).status || 500)
							}
							showDetails={true}
						>
					...
					<TabsContent value="handling" className="space-y-4">
						<p className="text-muted-foreground">
							Edge function errors should be handled consistently across the
							application. Use the <code>EdgeFunctionHandler</code> component or
							the <code>handleEdgeError</code> utility.
						</p>
