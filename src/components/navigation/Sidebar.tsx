        ...
        <ul className="space-y-1">
          ...
          <li>
            <Link
              to="/strategies"
              className={`flex items-center gap-3 rounded-md px-3 py-2 hover:bg-accent hover:text-accent-foreground ${
                isActive('/strategies') ? 'bg-accent text-accent-foreground' : ''
              }`}
            >
            ...
            <ul className="space-y-1">
              <li>
                <Link
                  to="/admin"
                  className={`flex items-center gap-3 rounded-md px-3 py-2 hover:bg-accent hover:text-accent-foreground ${
                    isActive('/admin') && location.pathname === '/admin' ? 'bg-accent text-accent-foreground' : ''
                  }`}
                >
                  <Home className="h-4 w-4" />
              ...
              <li>
                <Link
                  to="/admin/logs"
                  className={`flex items-center gap-3 rounded-md px-3 py-2 hover:bg-accent hover:text-accent-foreground ${
                    isActive('/admin/logs') ? 'bg-accent text-accent-foreground' : ''
                  }`}
                >
              ...
              <li>
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-md px-3 py-2 hover:bg-accent hover:text-accent-foreground ${
                    isActive('/admin/error-monitoring') ? 'bg-accent text-accent-foreground' : ''
                  }`}
                >
              ...
              <li>
                <Link
                  to="/admin/api-keys"
                  className={`flex items-center gap-3 rounded-md px-3 py-2 hover:bg-accent hover:text-accent-foreground ${
                    isActive('/admin/api-keys') ? 'bg-accent text-accent-foreground' : ''
                  }`}
                >
              ...
              <li>
                <Link
                  to="/admin/cron-jobs"
                  className={`flex items-center gap-3 rounded-md px-3 py-2 hover:bg-accent hover:text-accent-foreground ${
                    isActive('/admin/cron-jobs') ? 'bg-accent text-accent-foreground' : ''
                  }`}
                >
