    ...
    <div className="container py-8">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-2 gap-4">
            <Button
              onClick={() => toast('With description', {
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              onClick={() => {
                toast.promise(
                  new Promise((resolve) => {
                    setTimeout(() => resolve({ id: 123, name: 'Sample' }), 2000);
                  }),
                  {
            ...
            <Button
              onClick={() => {
                toast('Multiple lines', {
                  description: 'This is a very long description that should wrap to multiple lines. It contains a lot of text to demonstrate how the toast handles overflow.',
                });
              }}
            >
              Long Content
