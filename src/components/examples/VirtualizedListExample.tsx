...
const VirtualizedListExample: React.FC = () => {
  ...
  const { debouncedValue: debouncedSearch } = useOptimizedDebounce(
    searchQuery,
    300,
  );
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      const count =
        activeTab === "small" ? 100 : activeTab === "medium" ? 1000 : 10000;
  ...
  const handleTabChange = (value: string) => {
    ...
    setTimeout(() => {
      const count = value === "small" ? 100 : value === "medium" ? 1000 : 10000;
