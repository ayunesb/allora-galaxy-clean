  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="text-lg font-medium">Error Trends & Severity</CardTitle>
      </CardHeader>
      <CardContent>
        <ResponsiveContainer width="100%" height={height}>
          ...
          >
            ...
            <Bar dataKey="medium" name="Medium" stackId="severity" fill="#eab308" />
            <Bar dataKey="low" name="Low" stackId="severity" fill="#3b82f6" />
            <Line type="monotone" dataKey="total" name="Total Errors" stroke="#8884d8" strokeWidth={2} dot={{ r: 3 }} />
          </ComposedChart>
        </ResponsiveContainer>
      </CardContent>
    </Card>
