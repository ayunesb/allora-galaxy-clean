        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div className="group">
              ...
              <p className="text-lg font-medium">{plugin.category || 'Uncategorized'}</p>
            </div>
            ...
            <div className="bg-muted/30 p-4 rounded-md hover:bg-muted/50 transition-colors">
              <div className="flex gap-6">
                <div className="text-center">
                  <span className="text-3xl font-bold text-primary">{plugin.xp || 0}</span>
                  <p className="text-xs text-muted-foreground mt-1">XP Earned</p>
                </div>
                <div className="text-center">
                  <span className="text-3xl font-bold text-primary">{plugin.roi || 0}%</span>
