      ...
      <CardContent>
        {versions.length === 0 ? (
          <div className="text-center text-muted-foreground py-12 border border-dashed rounded-md">
            ...
            <p className="text-sm">Agent versions will appear here once created</p>
          </div>
        ) : (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <div className="flex items-center gap-2">
                    <Badge 
                      variant={version.status === 'active' ? 'default' : 
                              version.status === 'training' ? 'outline' : 'secondary'}
                  ...
                  <div className="text-right">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge variant="outline" className="text-green-500 hover:bg-green-50 transition-colors duration-300">
                        <ArrowUp className="h-3 w-3 mr-1" /> {version.upvotes || 0}
                      </Badge>
                      <Badge variant="outline" className="text-destructive hover:bg-red-50 transition-colors duration-300">
                        <ArrowDown className="h-3 w-3 mr-1" /> {version.downvotes || 0}
                      </Badge>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-3 flex justify-end gap-2">
                  ...
                  >
                    <Terminal className="mr-1 h-3 w-3 group-hover:text-primary transition-colors" /> Test
                  </Button>
                </div>
