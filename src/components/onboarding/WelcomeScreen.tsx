          ...
          <div className="flex flex-col gap-4 mt-4">
            <div className="bg-primary/5 border border-primary/10 rounded-lg p-4">
              ...
              <p className="text-sm text-muted-foreground">
                Your account has been created and you're ready to start setting
                up your workspace.
              </p>
            </div>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mt-4">
              <h3 className="font-medium mb-1 text-amber-800">
                Estimated Time: 5 minutes
              </h3>
              <p className="text-sm text-amber-700">
                This quick onboarding process will help us customize your
                experience and generate relevant AI strategies for your
                business.
              </p>
            </div>
          </div>
