...
export interface AuditLog {
  ...
  metadata?: any;
  created_at: string;
  user_id?: string; // Added user_id as optional field
}
...
// Add SystemEventModule enum that was missing
...
// Add SystemEventType enum that was missing
...
// Add UserRole type that was missing
